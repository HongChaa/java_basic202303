...
public class LibraryRepository {
    ...
    public Book kindOfBook(int bookNum) {

        if(bookList[bookNum] instanceof CookBook) {

            if(((CookBook)bookList[bookNum]).isCoupon()) {
            ...
            if ((CartoonBook)bookList[bookNum].getAccessAge()) {
