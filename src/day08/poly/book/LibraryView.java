    ...
    private static void selectMenu() {
        ...
        switch (menuNum) {
            ...
            case "3":
                ...
                break;
            case "4":
                String[] rentList = repository.getBookInfoList();
                System.out.println("\n============ 대여 도서 목록 ===========");
                for (int i = 0; i < rentList.length; i++) {
                    System.out.println(i+1 + "번째 도서: " + rentList[i]);
                }
                int selectedBookNum = Integer.parseInt(input("# 대여할 도서 번호 입력"));
                repository.kindOfBook(selectedBookNum);
